package improved_version.TrafficNetGenerator;
/******
  created by kwai
*****/

import improved_version.RoutesConstructor.BasicLink;
import improved_version.RoutesConstructor.BasicNode;
                                ...
                                if(flag && tag.equals("nd")){
                                    ...
                                    while(iter.hasNext()){
                                        ...
                                        if(linkNode.getID().equals(nid)) {
                                            nodeIDs.add(nid);
                                            lons.add(Double.parseDouble(linkNode.getX()));
                                            lats.add(Double.parseDouble(linkNode.getY()));
