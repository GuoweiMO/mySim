package improved_version.TripsGenerator;

import improved_version.DB_Interaction.JdbcUtils;
import improved_version.RoutesConstructor.BasicLink;
import improved_version.RoutesConstructor.KSPTree;
import improved_version.TrafficNetGenerator.OSMapReader;
...
public class CentroidsDesignator {
    ...
    LinkedList<BasicLink> linksSet;
    Set<Object> RemovedCentroids;
    WeightedGraph w_graph;
    OSMapReader reader;
    double[][] offsetX;
    double[][] offsetY;
    public CentroidsDesignator(OSMapReader reader,KSPTree kspTree,WeightedGraph w_graph,int rows,int cols){
        this.reader = reader;
        this.tree = kspTree;
    ...
    public void designateCentroids(){
        linksSet = reader.getMyBasicLinkSet();
...
//        }
        ...
        System.out.println("centroids are successfully designated. \n");
