package improved_version;

import older_version.RoutesConstructor.BasicLink;
import older_version.RoutesConstructor.BasicNode;
import org.w3c.dom.*;
...
public class GMLFileReader {
    ...
    public GMLFileReader(){
        ...
        BasicLinkSet = new ArrayList<BasicLink>();
    ...
    public Map<String, List<String>> getBasicLinkSet() {
        return BasicLinkSet;
    }
